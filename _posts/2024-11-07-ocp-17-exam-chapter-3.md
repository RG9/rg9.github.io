...
- **switch statement**
    - `case constantExpresion: { System.out.print("value"); }` (`;` is required)
    ...
    -
- **switch expressions**
    - `case constantExpresion -> { yield "value"; }` (`;` is required)
...
- **loops**
  ...
  - `break LABEL;` will go to expression stating with `LABEL: ` - basically label decided which loop should be called with `break` or `continue`
