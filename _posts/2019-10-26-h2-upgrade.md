...
Dependency upgrade sometimes may cause some fear of unknown ... especially when release contains 100+ changes :)
...
My project is using H2 in compatibility mode with `MySQL` and this came out to be the root of all evil ;)
...
I set breakpoint somewhere in `org.hibernate.mapping.Table` and application stopped on ... updating schema :)
...
I will leave it without answer. I'm not sure if such troubles can be avoided in the future :/
